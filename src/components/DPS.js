...
export default function DPS(props) {
  ...
  return (
    ...
    <div className=' justify-between flex flex-col  items-center backdrop-blur-lg top-1 fixed  z-10 h-screen w-screen'>
      ...
      <img src="https://static.vecteezy.com/system/resources/previews/008/909/270/non_2x/dps-logo-dps-letter-dps-letter-logo-design-initials-dps-logo-linked-with-circle-and-uppercase-monogram-logo-dps-typography-for-technology-business-and-real-estate-brand-vector.jpg"  className='logo rounded-full border  border-white h-12 w-12 ml-4 mt-4'/>

        <img src="https://png.pngtree.com/png-clipart/20220603/original/pngtree-flat-x-cross-mark-button-in-red-color-and-white-line-png-image_7900019.png" alt="" onClick={props.mody} className='h-12 w-12 m-5 rounded-full cursor-pointer   ' />
